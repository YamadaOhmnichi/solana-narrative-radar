...
Generated: 2026-09-16T12:34:07+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 134.0)

- GitHub repos matching: **15**  (top velocity 89.52 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **-14.24%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 69.4 stars/day
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change -14.24%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change -14.24% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 55.6)

- GitHub repos matching: **50**  (top velocity 23.6 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  - [neilveriemusm/Trpjan-solana-trading-toolkit](https://github.com/neilveriemusm/Trpjan-solana-trading-toolkit) — 5.85 stars/day
  - [dartkomnitibe/solana-meme-tool](https://github.com/dartkomnitibe/solana-meme-tool) — 5.71 stars/day
  - [PillCrew/claimchain](https://github.com/PillCrew/claimchain) — 3.54 stars/day

  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 50 trading-infrastructure repos at 23.6 stars/day.
...
### 3. Wallets & UX  —  confidence: Medium  (score 28.1)

- GitHub repos matching: **21**  (top velocity 20.12 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 21 new wallet/onboarding repos at 20.12 stars/day.
...
### 4. Security & Threats  —  confidence: Medium  (score 24.1)

- GitHub repos matching: **3**  (top velocity 0.1 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Open drainer-signature registry: community-maintained feed of known malicious program IDs + a free API dapps/wallets can query before signing (drainer repos at 0.1 stars/day show industrial-scale scam ops).
...
### 5. AI Agents on Solana  —  confidence: Medium  (score 17.2)

- GitHub repos matching: **21**  (top velocity 9.24 stars/day)
- Headline mentions (last fortnight): **1**
- Cross-source confirmation: **1/3**
  ...
  Top repos:
  - [PillCrew/claimchain](https://github.com/PillCrew/claimchain) — 3.54 stars/day
  - [PillCrew/PillCrew](https://github.com/PillCrew/PillCrew) — 2.08 stars/day
  - [SohniSwatantra/nosana-mcp](https://github.com/SohniSwatantra/nosana-mcp) — 1.36 stars/day

  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 9.24 stars/day).
...
### 6. Dev Tooling & Infra  —  confidence: Medium  (score 9.4)

- GitHub repos matching: **41**  (top velocity 9.4 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**

  Top repos:
  - [nicechunk/game](https://github.com/nicechunk/game) — 5.47 stars/day
  - [SohniSwatantra/nosana-mcp](https://github.com/SohniSwatantra/nosana-mcp) — 1.36 stars/day
  - [Mgabal/-AMM-Automated-Market-Maker-Solana-Anchor](https://github.com/Mgabal/-AMM-Automated-Market-Maker-Solana-Anchor) — 0.5 stars/day

  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 41 tooling repos at 9.4 stars/day).
...
- GitHub repos matching: **8**  (top velocity 6.53 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
