...
Generated: 2026-09-16T00:34:01+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 152.7)

- GitHub repos matching: **15**  (top velocity 106.09 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **-15.3%**
- Cross-source confirmation: **3/3**
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change -15.3%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change -15.3% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 56.5)

- GitHub repos matching: **51**  (top velocity 24.49 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 51 trading-infrastructure repos at 24.49 stars/day.
...
- GitHub repos matching: **21**  (top velocity 20.09 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 21 new wallet/onboarding repos at 20.09 stars/day.
...
- GitHub repos matching: **21**  (top velocity 9.18 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  Top repos:
  - [PillCrew/claimchain](https://github.com/PillCrew/claimchain) — 3.54 stars/day
  - [PillCrew/PillCrew](https://github.com/PillCrew/PillCrew) — 2.04 stars/day
  - [SohniSwatantra/nosana-mcp](https://github.com/SohniSwatantra/nosana-mcp) — 1.3 stars/day

  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 9.18 stars/day).
...
- GitHub repos matching: **42**  (top velocity 9.41 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 42 tooling repos at 9.41 stars/day).
...
- GitHub repos matching: **8**  (top velocity 6.38 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
