...
Generated: 2026-09-19T18:28:21+00:00  |  Methodology v0.1
...
### 1. DeFi / Trading Infra  —  confidence: High  (score 103.2)

- GitHub repos matching: **49**  (top velocity 63.16 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  Top repos:
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 37.75 stars/day
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 49 trading-infrastructure repos at 63.16 stars/day.
...
### 2. Meme & Speculation  —  confidence: High  (score 102.3)

- GitHub repos matching: **18**  (top velocity 61.03 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **12.62%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 46.0 stars/day
  - [dartkomnitibe/solana-meme-tool](https://github.com/dartkomnitibe/solana-meme-tool) — 4.08 stars/day
  - [neilveriemusm/Trpjan-solana-trading-toolkit](https://github.com/neilveriemusm/Trpjan-solana-trading-toolkit) — 4.05 stars/day

  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change 12.62%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change 12.62% so traders see which launches have real retention vs. pure rotation.

### 3. RWA & Tokenization  —  confidence: High  (score 97.6)

- GitHub repos matching: **5**  (top velocity 81.62 stars/day)
- Headline mentions (last fortnight): **2**
- Cross-source confirmation: **2/3**
  ...
  Top repos:
  - [coolbbcamp/Synthetic-Liquidity-Depth-Scanner](https://github.com/coolbbcamp/Synthetic-Liquidity-Depth-Scanner) — 43.75 stars/day
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 37.75 stars/day
...
### 4. Wallets & UX  —  confidence: Medium  (score 61.6)

- GitHub repos matching: **19**  (top velocity 61.62 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 19 new wallet/onboarding repos at 61.62 stars/day.
...
### 5. Dev Tooling & Infra  —  confidence: Medium  (score 51.0)

- GitHub repos matching: **42**  (top velocity 51.04 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 37.75 stars/day
  - [openarbmev/Openarb-Trade-SDK](https://github.com/openarbmev/Openarb-Trade-SDK) — 9.56 stars/day
  - [SohniSwatantra/nosana-mcp](https://github.com/SohniSwatantra/nosana-mcp) — 1.36 stars/day

  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 42 tooling repos at 51.04 stars/day).
...
### 6. Security & Threats  —  confidence: Medium  (score 17.1)
...
### 7. AI Agents on Solana  —  confidence: Medium  (score 15.5)

- GitHub repos matching: **21**  (top velocity 7.47 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 7.47 stars/day).
...
- GitHub repos matching: **2**  (top velocity 1.38 stars/day)
- Headline mentions (last fortnight): **0**
