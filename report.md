...
### 1. Meme & Speculation  —  confidence: High  (score 70.1)

- GitHub repos matching: **15**  (top velocity 30.26 stars/day)
- Headline mentions (last fortnight): **4**
- Market 7d avg change: **3.93%**
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change 3.93%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change 3.93% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 65.8)

- GitHub repos matching: **47**  (top velocity 33.81 stars/day)
- Headline mentions (last fortnight): **4**
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 47 trading-infrastructure repos at 33.81 stars/day.
...
- GitHub repos matching: **17**  (top velocity 25.12 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 17 new wallet/onboarding repos at 25.12 stars/day.
...
- GitHub repos matching: **5**  (top velocity 0.29 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  Top repos:
  - [hypnogaba/solana-signal-trader](https://github.com/hypnogaba/solana-signal-trader) — 0.15 stars/day
  ...
  **Build ideas:**
  - Open drainer-signature registry: community-maintained feed of known malicious program IDs + a free API dapps/wallets can query before signing (drainer repos at 0.29 stars/day show industrial-scale scam ops).
...
- GitHub repos matching: **24**  (top velocity 12.87 stars/day)
- Headline mentions (last fortnight): **2**
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 12.87 stars/day).
...
### 6. RWA & Tokenization  —  confidence: Low  (score 8.2)

- GitHub repos matching: **3**  (top velocity 0.18 stars/day)
...
- Cross-source confirmation: **0/3**
  ...
  Top repos:
  - [keelwright/slipway](https://github.com/keelwright/slipway) — 0.11 stars/day
  - [thesithunyein/equxi](https://github.com/thesithunyein/equxi) — 0.05 stars/day
  - [Diam0naz/attention-fi](https://github.com/Diam0naz/attention-fi) — 0.02 stars/day
...
### 7. Dev Tooling & Infra  —  confidence: Medium  (score 8.2)

- GitHub repos matching: **43**  (top velocity 8.17 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 43 tooling repos at 8.17 stars/day).
...
### 8. Consumer & Social  —  confidence: Medium  (score 6.9)

- GitHub repos matching: **5**  (top velocity 6.92 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  - [accretion-xyz/awesome-solana-security](https://github.com/accretion-xyz/awesome-solana-security) — 0.27 stars/day
