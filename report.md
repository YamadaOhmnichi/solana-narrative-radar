...
Generated: 2026-09-17T00:34:37+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 108.1)

- GitHub repos matching: **17**  (top velocity 88.61 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **-1.74%**
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change -1.74%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change -1.74% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 52.9)

- GitHub repos matching: **49**  (top velocity 20.9 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 49 trading-infrastructure repos at 20.9 stars/day.
...
- GitHub repos matching: **21**  (top velocity 8.11 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 8.11 stars/day).
...
- GitHub repos matching: **19**  (top velocity 19.67 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 19 new wallet/onboarding repos at 19.67 stars/day.
...
- GitHub repos matching: **40**  (top velocity 9.3 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 40 tooling repos at 9.3 stars/day).
