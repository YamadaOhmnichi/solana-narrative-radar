...
Generated: 2026-09-13T06:35:18+00:00  |  Methodology v0.1
...
### 1. DeFi / Trading Infra  —  confidence: High  (score 68.1)

- GitHub repos matching: **47**  (top velocity 28.07 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 47 trading-infrastructure repos at 28.07 stars/day.
...
### 2. Meme & Speculation  —  confidence: High  (score 55.9)

- GitHub repos matching: **14**  (top velocity 24.96 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **-7.46%**
- Cross-source confirmation: **3/3**
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change -7.46%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change -7.46% so traders see which launches have real retention vs. pure rotation.
...
- GitHub repos matching: **19**  (top velocity 22.12 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 19 new wallet/onboarding repos at 22.12 stars/day.
...
- GitHub repos matching: **21**  (top velocity 9.5 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 9.5 stars/day).
...
- GitHub repos matching: **7**  (top velocity 6.61 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
