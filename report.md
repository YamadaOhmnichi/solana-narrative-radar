...
Generated: 2026-09-24T00:35:06+00:00  |  Methodology v0.1
...
- Cross-source confirmation: **3/3**
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change 18.01%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change 18.01% so traders see which launches have real retention vs. pure rotation.
...
### 3. Wallets & UX  —  confidence: Medium  (score 92.1)

- GitHub repos matching: **20**  (top velocity 92.09 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**

  Top repos:
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 29.38 stars/day
  - [uni-launch/solana-token-creator](https://github.com/uni-launch/solana-token-creator) — 26.0 stars/day
  - [Kylerkrausemdzyra64/Crypto-Checker](https://github.com/Kylerkrausemdzyra64/Crypto-Checker) — 17.6 stars/day

  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 20 new wallet/onboarding repos at 92.09 stars/day.
...
### 6. AI Agents on Solana  —  confidence: High  (score 28.8)

- GitHub repos matching: **16**  (top velocity 4.8 stars/day)
- Headline mentions (last fortnight): **3**
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 4.8 stars/day).
...
### 7. Payments & Stablecoins  —  confidence: Medium  (score 27.3)

- GitHub repos matching: **8**  (top velocity 19.29 stars/day)
...
### 8. Consumer & Social  —  confidence: Medium  (score 27.2)

- GitHub repos matching: **7**  (top velocity 27.25 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
