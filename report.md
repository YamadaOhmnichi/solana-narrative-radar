...
Generated: 2026-09-16T18:30:50+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 136.3)

- GitHub repos matching: **17**  (top velocity 88.88 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **-15.73%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 69.8 stars/day
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change -15.73%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change -15.73% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 53.1)

- GitHub repos matching: **49**  (top velocity 21.15 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 49 trading-infrastructure repos at 21.15 stars/day.
...
### 3. Security & Threats  —  confidence: Medium  (score 33.5)

- GitHub repos matching: **4**  (top velocity 1.5 stars/day)
- Headline mentions (last fortnight): **4**
- Cross-source confirmation: **1/3**
  ...
  Top repos:
  - [andreysuperiorgit/aegis](https://github.com/andreysuperiorgit/aegis) — 1.4 stars/day
  ...
  **Build ideas:**
  - Open drainer-signature registry: community-maintained feed of known malicious program IDs + a free API dapps/wallets can query before signing (drainer repos at 1.5 stars/day show industrial-scale scam ops).
...
### 4. Wallets & UX  —  confidence: Medium  (score 27.8)

- GitHub repos matching: **19**  (top velocity 19.82 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 19 new wallet/onboarding repos at 19.82 stars/day.
...
### 5. AI Agents on Solana  —  confidence: High  (score 24.4)

- GitHub repos matching: **21**  (top velocity 8.39 stars/day)
- Headline mentions (last fortnight): **2**
- Cross-source confirmation: **2/3**
  ...
  Top repos:
  - [PillCrew/claimchain](https://github.com/PillCrew/claimchain) — 2.08 stars/day
  - [SohniSwatantra/nosana-mcp](https://github.com/SohniSwatantra/nosana-mcp) — 1.45 stars/day
  - [andreysuperiorgit/aegis](https://github.com/andreysuperiorgit/aegis) — 1.4 stars/day

  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 8.39 stars/day).
...
- GitHub repos matching: **40**  (top velocity 9.47 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**

  Top repos:
  - [nicechunk/game](https://github.com/nicechunk/game) — 5.45 stars/day
  - [SohniSwatantra/nosana-mcp](https://github.com/SohniSwatantra/nosana-mcp) — 1.45 stars/day
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 40 tooling repos at 9.47 stars/day).
...
- GitHub repos matching: **7**  (top velocity 0.37 stars/day)
- Headline mentions (last fortnight): **1**
