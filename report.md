...
Generated: 2026-09-20T18:28:44+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 244.7)

- GitHub repos matching: **17**  (top velocity 204.98 stars/day)
...
- Cross-source confirmation: **3/3**
  ...
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 43.78 stars/day
...
### 2. DeFi / Trading Infra  —  confidence: High  (score 202.6)

- GitHub repos matching: **49**  (top velocity 162.61 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 38.0 stars/day

  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 49 trading-infrastructure repos at 162.61 stars/day.
...
### 3. RWA & Tokenization  —  confidence: Medium  (score 140.7)

- GitHub repos matching: **7**  (top velocity 132.66 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  Top repos:
  - [gprokaznik4-bit/SolanaSniperBot-OpenSource](https://github.com/gprokaznik4-bit/SolanaSniperBot-OpenSource) — 51.0 stars/day
  - [coolbbcamp/Synthetic-Liquidity-Depth-Scanner](https://github.com/coolbbcamp/Synthetic-Liquidity-Depth-Scanner) — 43.4 stars/day
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 38.0 stars/day
...
### 4. Dev Tooling & Infra  —  confidence: Medium  (score 100.7)

- GitHub repos matching: **43**  (top velocity 100.72 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 43 tooling repos at 100.72 stars/day).
...
### 5. Wallets & UX  —  confidence: Medium  (score 60.5)

- GitHub repos matching: **19**  (top velocity 60.53 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 19 new wallet/onboarding repos at 60.53 stars/day.
...
- GitHub repos matching: **18**  (top velocity 6.05 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 6.05 stars/day).
