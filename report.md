...
Generated: 2026-09-18T18:29:20+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 98.9)

- GitHub repos matching: **18**  (top velocity 67.23 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **7.81%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 51.71 stars/day
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change 7.81%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change 7.81% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 55.2)

- GitHub repos matching: **50**  (top velocity 23.22 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  Top repos:
  - [openarbmev/Openarb-Trade-SDK](https://github.com/openarbmev/Openarb-Trade-SDK) — 6.38 stars/day
  - [dartkomnitibe/solana-meme-tool](https://github.com/dartkomnitibe/solana-meme-tool) — 4.19 stars/day
  - [neilveriemusm/Trpjan-solana-trading-toolkit](https://github.com/neilveriemusm/Trpjan-solana-trading-toolkit) — 4.17 stars/day

  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 50 trading-infrastructure repos at 23.22 stars/day.
...
### 3. AI Agents on Solana  —  confidence: High  (score 23.7)

- GitHub repos matching: **21**  (top velocity 7.74 stars/day)
- Headline mentions (last fortnight): **2**
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 7.74 stars/day).
...
### 4. Wallets & UX  —  confidence: Medium  (score 21.3)

- GitHub repos matching: **18**  (top velocity 21.29 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 18 new wallet/onboarding repos at 21.29 stars/day.
...
### 6. RWA & Tokenization  —  confidence: Medium  (score 16.1)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - RWA disclosure registry: standard JSON schema + on-chain hash for tokenized asset disclosures; low-current-signal (3 repos, Medium confidence) makes this a land-grab moment.
...
### 7. Dev Tooling & Infra  —  confidence: Medium  (score 15.3)

- GitHub repos matching: **42**  (top velocity 15.26 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**

  Top repos:
  - [openarbmev/Openarb-Trade-SDK](https://github.com/openarbmev/Openarb-Trade-SDK) — 6.38 stars/day
  - [nicechunk/game](https://github.com/nicechunk/game) — 5.25 stars/day
  - [SohniSwatantra/nosana-mcp](https://github.com/SohniSwatantra/nosana-mcp) — 1.38 stars/day

  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 42 tooling repos at 15.26 stars/day).
...
- GitHub repos matching: **7**  (top velocity 6.36 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
