...
Generated: 2026-09-14T00:36:02+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 190.3)

- GitHub repos matching: **16**  (top velocity 142.67 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **-15.8%**
- Cross-source confirmation: **3/3**
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change -15.8%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change -15.8% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 67.5)

- GitHub repos matching: **49**  (top velocity 27.54 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 49 trading-infrastructure repos at 27.54 stars/day.
...
- GitHub repos matching: **19**  (top velocity 9.6 stars/day)
- Headline mentions (last fortnight): **2**
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 9.6 stars/day).
...
- GitHub repos matching: **20**  (top velocity 21.36 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 20 new wallet/onboarding repos at 21.36 stars/day.
...
- GitHub repos matching: **41**  (top velocity 9.02 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 41 tooling repos at 9.02 stars/day).
...
- GitHub repos matching: **8**  (top velocity 6.59 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
