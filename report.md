...
Generated: 2026-09-25T12:34:22+00:00  |  Methodology v0.1
...
### 1. Wallets & UX  —  confidence: High  (score 166.9)

- GitHub repos matching: **21**  (top velocity 150.91 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  Top repos:
  - [uni-launch/solana-token-creator](https://github.com/uni-launch/solana-token-creator) — 94.0 stars/day
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 26.11 stars/day
  - [Kylerkrausemdzyra64/Crypto-Checker](https://github.com/Kylerkrausemdzyra64/Crypto-Checker) — 12.57 stars/day

  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 21 new wallet/onboarding repos at 150.91 stars/day.
...
### 2. Meme & Speculation  —  confidence: High  (score 95.8)

- GitHub repos matching: **12**  (top velocity 45.11 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **17.37%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 34.21 stars/day
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change 17.37%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change 17.37% so traders see which launches have real retention vs. pure rotation.

### 3. Consumer & Social  —  confidence: Medium  (score 95.2)

- GitHub repos matching: **7**  (top velocity 95.22 stars/day)
...
### 4. DeFi / Trading Infra  —  confidence: High  (score 84.3)

- GitHub repos matching: **49**  (top velocity 60.31 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 49 trading-infrastructure repos at 60.31 stars/day.
...
### 5. RWA & Tokenization  —  confidence: High  (score 71.1)

- GitHub repos matching: **6**  (top velocity 55.14 stars/day)
- Headline mentions (last fortnight): **2**
- Cross-source confirmation: **2/3**
...
### 6. Dev Tooling & Infra  —  confidence: Medium  (score 60.7)

- GitHub repos matching: **44**  (top velocity 60.7 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 44 tooling repos at 60.7 stars/day).
...
### 8. Security & Threats  —  confidence: Medium  (score 32.0)
