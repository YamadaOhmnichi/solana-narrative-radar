...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change 3.42%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change 3.42% so traders see which launches have real retention vs. pure rotation.
...
- Cross-source confirmation: **0/3**
  ...
  Top repos:
  - [keelwright/slipway](https://github.com/keelwright/slipway) — 0.1 stars/day
