...
Generated: 2026-09-26T12:31:45+00:00  |  Methodology v0.1
...
### 1. Wallets & UX  —  confidence: Medium  (score 92.3)

- GitHub repos matching: **20**  (top velocity 84.33 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 20 new wallet/onboarding repos at 84.33 stars/day.
...
### 2. Meme & Speculation  —  confidence: High  (score 83.1)

- GitHub repos matching: **13**  (top velocity 42.97 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **12.06%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 32.27 stars/day
  - [neilveriemusm/Trpjan-solana-trading-toolkit](https://github.com/neilveriemusm/Trpjan-solana-trading-toolkit) — 3.49 stars/day
  - [dartkomnitibe/solana-meme-tool](https://github.com/dartkomnitibe/solana-meme-tool) — 3.43 stars/day

  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change 12.06%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change 12.06% so traders see which launches have real retention vs. pure rotation.

### 3. Consumer & Social  —  confidence: Medium  (score 64.7)

- GitHub repos matching: **7**  (top velocity 56.71 stars/day)
- Headline mentions (last fortnight): **1**
- Cross-source confirmation: **1/3**
...
### 4. DeFi / Trading Infra  —  confidence: High  (score 53.7)

- GitHub repos matching: **48**  (top velocity 29.68 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 48 trading-infrastructure repos at 29.68 stars/day.
...
### 5. Security & Threats  —  confidence: Medium  (score 48.0)
...
### 6. Payments & Stablecoins  —  confidence: High  (score 32.9)

- GitHub repos matching: **4**  (top velocity 8.89 stars/day)
- Headline mentions (last fortnight): **3**
- Cross-source confirmation: **2/3**
...
### 7. Dev Tooling & Infra  —  confidence: Medium  (score 27.7)

- GitHub repos matching: **42**  (top velocity 27.74 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 42 tooling repos at 27.74 stars/day).
...
### 8. RWA & Tokenization  —  confidence: Medium  (score 24.3)

- GitHub repos matching: **4**  (top velocity 0.31 stars/day)
- Headline mentions (last fortnight): **3**
- Cross-source confirmation: **1/3**
  ...
  Top repos:
  - [thesithunyein/owed](https://github.com/thesithunyein/owed) — 0.2 stars/day
  - [keelwright/slipway](https://github.com/keelwright/slipway) — 0.06 stars/day
  - [thesithunyein/equxi](https://github.com/thesithunyein/equxi) — 0.03 stars/day
