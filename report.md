...
Generated: 2026-09-13T18:29:21+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 189.2)

- GitHub repos matching: **15**  (top velocity 143.2 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **-15.02%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 119.0 stars/day
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change -15.02%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change -15.02% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 67.7)

- GitHub repos matching: **47**  (top velocity 27.66 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 47 trading-infrastructure repos at 27.66 stars/day.
...
### 3. AI Agents on Solana  —  confidence: High  (score 25.5)

- GitHub repos matching: **21**  (top velocity 9.47 stars/day)
- Headline mentions (last fortnight): **2**
- Cross-source confirmation: **2/3**
  ...
  - [kaiserern/Kaiser.charon](https://github.com/kaiserern/Kaiser.charon) — 1.15 stars/day

  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 9.47 stars/day).
...
- GitHub repos matching: **3**  (top velocity 0.19 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Open drainer-signature registry: community-maintained feed of known malicious program IDs + a free API dapps/wallets can query before signing (drainer repos at 0.19 stars/day show industrial-scale scam ops).
...
### 5. Wallets & UX  —  confidence: Medium  (score 21.5)

- GitHub repos matching: **19**  (top velocity 21.5 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 19 new wallet/onboarding repos at 21.5 stars/day.
...
- GitHub repos matching: **39**  (top velocity 8.36 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**

  Top repos:
  - [nicechunk/game](https://github.com/nicechunk/game) — 5.75 stars/day
  - [antonkarasbiz/solana-program-examples](https://github.com/antonkarasbiz/solana-program-examples) — 1.0 stars/day
  - [fluxrpc/solana-go](https://github.com/fluxrpc/solana-go) — 0.28 stars/day

  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 39 tooling repos at 8.36 stars/day).
...
### 7. Consumer & Social  —  confidence: Medium  (score 6.6)

- GitHub repos matching: **7**  (top velocity 6.56 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
...
- GitHub repos matching: **5**  (top velocity 0.36 stars/day)
- Headline mentions (last fortnight): **0**
