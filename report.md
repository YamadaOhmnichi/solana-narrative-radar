...
Generated: 2026-09-25T18:29:53+00:00  |  Methodology v0.1
...
### 1. Wallets & UX  —  confidence: High  (score 123.8)

- GitHub repos matching: **21**  (top velocity 107.76 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  Top repos:
  - [uni-launch/solana-token-creator](https://github.com/uni-launch/solana-token-creator) — 54.0 stars/day
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 21 new wallet/onboarding repos at 107.76 stars/day.
...
### 2. Meme & Speculation  —  confidence: High  (score 84.3)

- GitHub repos matching: **12**  (top velocity 45.39 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **11.46%**
- Cross-source confirmation: **3/3**
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change 11.46%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change 11.46% so traders see which launches have real retention vs. pure rotation.

### 3. DeFi / Trading Infra  —  confidence: High  (score 75.6)

- GitHub repos matching: **48**  (top velocity 51.64 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 48 trading-infrastructure repos at 51.64 stars/day.
...
### 5. Consumer & Social  —  confidence: Medium  (score 63.3)

- GitHub repos matching: **7**  (top velocity 55.26 stars/day)
...
- GitHub repos matching: **44**  (top velocity 53.44 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 44 tooling repos at 53.44 stars/day).
...
### 8. Payments & Stablecoins  —  confidence: High  (score 33.0)

- GitHub repos matching: **6**  (top velocity 8.95 stars/day)
- Headline mentions (last fortnight): **3**
- Cross-source confirmation: **2/3**
