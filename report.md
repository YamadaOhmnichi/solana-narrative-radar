...
Generated: 2026-09-11T18:30:56+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 114.2)

- GitHub repos matching: **15**  (top velocity 82.08 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **-8.07%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 55.0 stars/day
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change -8.07%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change -8.07% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 79.1)

- GitHub repos matching: **47**  (top velocity 31.08 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 47 trading-infrastructure repos at 31.08 stars/day.
...
### 3. AI Agents on Solana  —  confidence: High  (score 34.9)

- GitHub repos matching: **23**  (top velocity 10.93 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 10.93 stars/day).
...
- GitHub repos matching: **5**  (top velocity 0.26 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Open drainer-signature registry: community-maintained feed of known malicious program IDs + a free API dapps/wallets can query before signing (drainer repos at 0.26 stars/day show industrial-scale scam ops).
...
### 5. Wallets & UX  —  confidence: Medium  (score 23.3)

- GitHub repos matching: **19**  (top velocity 23.3 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 19 new wallet/onboarding repos at 23.3 stars/day.
...
### 6. Dev Tooling & Infra  —  confidence: Medium  (score 7.8)

- GitHub repos matching: **42**  (top velocity 7.77 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 42 tooling repos at 7.77 stars/day).
...
- GitHub repos matching: **6**  (top velocity 6.83 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
