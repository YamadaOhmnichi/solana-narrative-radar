...
Generated: 2026-09-21T06:35:47+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 246.2)

- GitHub repos matching: **16**  (top velocity 206.22 stars/day)
- Headline mentions (last fortnight): **3**
- Market 7d avg change: **7.98%**
- Cross-source confirmation: **3/3**
  ...
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 46.11 stars/day

  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change 7.98%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change 7.98% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 209.9)

- GitHub repos matching: **48**  (top velocity 169.88 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 45.4 stars/day

  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 48 trading-infrastructure repos at 169.88 stars/day.
...
### 3. RWA & Tokenization  —  confidence: Medium  (score 154.5)

- GitHub repos matching: **6**  (top velocity 146.51 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  Top repos:
  - [gprokaznik4-bit/SolanaSniperBot-OpenSource](https://github.com/gprokaznik4-bit/SolanaSniperBot-OpenSource) — 51.0 stars/day
  - [coolbbcamp/Synthetic-Liquidity-Depth-Scanner](https://github.com/coolbbcamp/Synthetic-Liquidity-Depth-Scanner) — 50.0 stars/day
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 45.4 stars/day
...
### 4. Dev Tooling & Infra  —  confidence: Medium  (score 107.9)

- GitHub repos matching: **43**  (top velocity 107.86 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 43 tooling repos at 107.86 stars/day).
...
### 5. Wallets & UX  —  confidence: Medium  (score 67.9)

- GitHub repos matching: **19**  (top velocity 67.86 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 19 new wallet/onboarding repos at 67.86 stars/day.
...
- GitHub repos matching: **17**  (top velocity 4.95 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 4.95 stars/day).
