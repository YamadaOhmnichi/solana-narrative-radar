...
Generated: 2026-09-21T00:35:09+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 248.4)

- GitHub repos matching: **16**  (top velocity 204.33 stars/day)
- Headline mentions (last fortnight): **3**
- Market 7d avg change: **10.01%**
- Cross-source confirmation: **3/3**
  ...
  - [gprokaznik4-bit/SolanaSniperBot-OpenSource](https://github.com/gprokaznik4-bit/SolanaSniperBot-OpenSource) — 51.0 stars/day
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 44.22 stars/day

  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change 10.01%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change 10.01% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 206.1)

- GitHub repos matching: **48**  (top velocity 166.08 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  Top repos:
  - [gprokaznik4-bit/SolanaSniperBot-OpenSource](https://github.com/gprokaznik4-bit/SolanaSniperBot-OpenSource) — 51.0 stars/day
  - [gprokaznik4-bit/Solana-Jito-Bundler](https://github.com/gprokaznik4-bit/Solana-Jito-Bundler) — 51.0 stars/day
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 41.6 stars/day

  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 48 trading-infrastructure repos at 166.08 stars/day.
...
### 3. RWA & Tokenization  —  confidence: Medium  (score 147.3)

- GitHub repos matching: **7**  (top velocity 139.26 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  Top repos:
  - [gprokaznik4-bit/SolanaSniperBot-OpenSource](https://github.com/gprokaznik4-bit/SolanaSniperBot-OpenSource) — 51.0 stars/day
  - [coolbbcamp/Synthetic-Liquidity-Depth-Scanner](https://github.com/coolbbcamp/Synthetic-Liquidity-Depth-Scanner) — 46.4 stars/day
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 41.6 stars/day
...
### 4. Dev Tooling & Infra  —  confidence: Medium  (score 104.2)

- GitHub repos matching: **43**  (top velocity 104.19 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 43 tooling repos at 104.19 stars/day).
...
### 5. Wallets & UX  —  confidence: Medium  (score 64.1)

- GitHub repos matching: **19**  (top velocity 64.06 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 19 new wallet/onboarding repos at 64.06 stars/day.
...
### 6. Security & Threats  —  confidence: Medium  (score 16.1)
...
### 8. AI Agents on Solana  —  confidence: Medium  (score 5.0)

- GitHub repos matching: **17**  (top velocity 4.96 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 4.96 stars/day).
