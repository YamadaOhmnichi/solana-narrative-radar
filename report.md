...
Generated: 2026-09-22T06:33:26+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 207.7)

- GitHub repos matching: **16**  (top velocity 152.32 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **19.71%**
- Cross-source confirmation: **3/3**
  ...
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 42.7 stars/day
  - [dartkomnitibe/solana-meme-tool](https://github.com/dartkomnitibe/solana-meme-tool) — 3.87 stars/day

  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change 19.71%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change 19.71% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 99.0)

- GitHub repos matching: **47**  (top velocity 67.01 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 47 trading-infrastructure repos at 67.01 stars/day.
...
### 4. Wallets & UX  —  confidence: Medium  (score 89.3)

- GitHub repos matching: **20**  (top velocity 89.28 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**

  Top repos:
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 39.17 stars/day
  - [Kylerkrausemdzyra64/Crypto-Checker](https://github.com/Kylerkrausemdzyra64/Crypto-Checker) — 29.0 stars/day
  - [openarbmev/Openarb-Trade-SDK](https://github.com/openarbmev/Openarb-Trade-SDK) — 7.82 stars/day

  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 20 new wallet/onboarding repos at 89.28 stars/day.
...
### 5. Dev Tooling & Infra  —  confidence: Medium  (score 50.0)

- GitHub repos matching: **42**  (top velocity 50.04 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 42 tooling repos at 50.04 stars/day).
...
### 6. AI Agents on Solana  —  confidence: High  (score 31.5)

- GitHub repos matching: **19**  (top velocity 7.53 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 7.53 stars/day).
