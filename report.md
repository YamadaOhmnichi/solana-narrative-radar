...
Generated: 2026-09-16T06:34:22+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 155.2)

- GitHub repos matching: **15**  (top velocity 106.61 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **-16.31%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 86.25 stars/day
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change -16.31%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change -16.31% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 56.0)

- GitHub repos matching: **51**  (top velocity 24.01 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 51 trading-infrastructure repos at 24.01 stars/day.
...
### 3. Security & Threats  —  confidence: Medium  (score 24.2)
...
### 4. Wallets & UX  —  confidence: Medium  (score 20.1)

- GitHub repos matching: **21**  (top velocity 20.08 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 21 new wallet/onboarding repos at 20.08 stars/day.
...
### 5. AI Agents on Solana  —  confidence: Medium  (score 17.3)

- GitHub repos matching: **21**  (top velocity 9.3 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  - [SohniSwatantra/nosana-mcp](https://github.com/SohniSwatantra/nosana-mcp) — 1.4 stars/day
...
- GitHub repos matching: **42**  (top velocity 8.84 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 42 tooling repos at 8.84 stars/day).
...
### 8. Consumer & Social  —  confidence: Medium  (score 6.3)

- GitHub repos matching: **8**  (top velocity 6.34 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  - [dizcorvus/opencatz-ai](https://github.com/dizcorvus/opencatz-ai) — 0.23 stars/day
