...
Generated: 2026-09-15T00:36:44+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 182.1)

- GitHub repos matching: **16**  (top velocity 144.57 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **-10.77%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 111.33 stars/day
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change -10.77%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change -10.77% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 76.9)

- GitHub repos matching: **50**  (top velocity 36.94 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 50 trading-infrastructure repos at 36.94 stars/day.
...
### 3. AI Agents on Solana  —  confidence: High  (score 41.1)

- GitHub repos matching: **19**  (top velocity 9.1 stars/day)
...
- GitHub repos matching: **19**  (top velocity 20.68 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 19 new wallet/onboarding repos at 20.68 stars/day.
...
- GitHub repos matching: **42**  (top velocity 8.53 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**

  Top repos:
  - [nicechunk/game](https://github.com/nicechunk/game) — 5.68 stars/day
  - [SohniSwatantra/nosana-mcp](https://github.com/SohniSwatantra/nosana-mcp) — 0.89 stars/day
  - [antonkarasbiz/solana-program-examples](https://github.com/antonkarasbiz/solana-program-examples) — 0.67 stars/day

  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 42 tooling repos at 8.53 stars/day).
...
- GitHub repos matching: **5**  (top velocity 0.34 stars/day)
- Headline mentions (last fortnight): **1**
