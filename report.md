...
Generated: 2026-09-13T12:31:30+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 177.8)

- GitHub repos matching: **15**  (top velocity 140.4 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **-10.7%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 116.0 stars/day
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change -10.7%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change -10.7% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 68.0)

- GitHub repos matching: **48**  (top velocity 28.01 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 48 trading-infrastructure repos at 28.01 stars/day.
...
### 4. Wallets & UX  —  confidence: Medium  (score 21.9)

- GitHub repos matching: **19**  (top velocity 21.91 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 19 new wallet/onboarding repos at 21.91 stars/day.
...
- GitHub repos matching: **21**  (top velocity 9.48 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 9.48 stars/day).
...
### 6. Dev Tooling & Infra  —  confidence: Medium  (score 8.5)

- GitHub repos matching: **41**  (top velocity 8.48 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 41 tooling repos at 8.48 stars/day).
...
- GitHub repos matching: **7**  (top velocity 6.58 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
