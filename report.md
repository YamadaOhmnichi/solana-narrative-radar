...
Generated: 2026-09-14T12:35:18+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 182.6)

- GitHub repos matching: **16**  (top velocity 140.57 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **-13.03%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 106.67 stars/day
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change -13.03%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change -13.03% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 77.7)

- GitHub repos matching: **49**  (top velocity 37.66 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 49 trading-infrastructure repos at 37.66 stars/day.
...
- GitHub repos matching: **19**  (top velocity 9.47 stars/day)
- Headline mentions (last fortnight): **2**
- Cross-source confirmation: **2/3**
...
### 5. Wallets & UX  —  confidence: Medium  (score 21.2)

- GitHub repos matching: **20**  (top velocity 21.16 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 20 new wallet/onboarding repos at 21.16 stars/day.
...
- GitHub repos matching: **41**  (top velocity 8.52 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 41 tooling repos at 8.52 stars/day).
...
- GitHub repos matching: **8**  (top velocity 6.52 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
