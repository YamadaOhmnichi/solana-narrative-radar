...
Generated: 2026-09-17T18:31:25+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 112.7)

- GitHub repos matching: **17**  (top velocity 77.61 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **9.52%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 59.17 stars/day
  - [dartkomnitibe/solana-meme-tool](https://github.com/dartkomnitibe/solana-meme-tool) — 5.54 stars/day
  - [neilveriemusm/Trpjan-solana-trading-toolkit](https://github.com/neilveriemusm/Trpjan-solana-trading-toolkit) — 5.51 stars/day

  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change 9.52%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change 9.52% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 60.2)

- GitHub repos matching: **49**  (top velocity 20.24 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 49 trading-infrastructure repos at 20.24 stars/day.
...
### 3. Security & Threats  —  confidence: Medium  (score 33.4)
...
### 4. AI Agents on Solana  —  confidence: High  (score 23.9)

- GitHub repos matching: **21**  (top velocity 7.95 stars/day)
- Headline mentions (last fortnight): **2**
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 7.95 stars/day).
...
### 5. Wallets & UX  —  confidence: Medium  (score 19.3)

- GitHub repos matching: **19**  (top velocity 19.3 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 19 new wallet/onboarding repos at 19.3 stars/day.
...
### 7. Dev Tooling & Infra  —  confidence: Medium  (score 9.0)

- GitHub repos matching: **40**  (top velocity 8.96 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  - [SohniSwatantra/nosana-mcp](https://github.com/SohniSwatantra/nosana-mcp) — 1.33 stars/day
  - [blueshift-gg/solana-awesome](https://github.com/blueshift-gg/solana-awesome) — 0.5 stars/day

  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 40 tooling repos at 8.96 stars/day).
...
### 8. Payments & Stablecoins  —  confidence: Low  (score 8.4)
