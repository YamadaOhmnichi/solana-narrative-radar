...
Generated: 2026-09-12T00:33:35+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 140.3)

- GitHub repos matching: **15**  (top velocity 103.31 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **-10.52%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 77.0 stars/day
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change -10.52%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change -10.52% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 78.7)

- GitHub repos matching: **51**  (top velocity 30.72 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 51 trading-infrastructure repos at 30.72 stars/day.
...
- GitHub repos matching: **23**  (top velocity 10.15 stars/day)
- Headline mentions (last fortnight): **2**
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 10.15 stars/day).
...
- GitHub repos matching: **19**  (top velocity 23.14 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 19 new wallet/onboarding repos at 23.14 stars/day.
...
- GitHub repos matching: **41**  (top velocity 7.89 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 41 tooling repos at 7.89 stars/day).
...
- GitHub repos matching: **7**  (top velocity 6.85 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
