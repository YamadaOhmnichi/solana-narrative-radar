...
Generated: 2026-09-17T12:33:35+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 100.2)

- GitHub repos matching: **17**  (top velocity 77.78 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **3.2%**
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change 3.2%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change 3.2% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 52.1)

- GitHub repos matching: **48**  (top velocity 20.12 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 48 trading-infrastructure repos at 20.12 stars/day.
...
- GitHub repos matching: **21**  (top velocity 7.96 stars/day)
- Headline mentions (last fortnight): **2**
- Cross-source confirmation: **2/3**
  ...
  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 7.96 stars/day).
...
### 5. Wallets & UX  —  confidence: Medium  (score 19.6)

- GitHub repos matching: **19**  (top velocity 19.56 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 19 new wallet/onboarding repos at 19.56 stars/day.
...
### 6. Dev Tooling & Infra  —  confidence: Medium  (score 8.9)

- GitHub repos matching: **40**  (top velocity 8.92 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 40 tooling repos at 8.92 stars/day).
