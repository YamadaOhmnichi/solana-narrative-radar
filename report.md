...
Generated: 2026-09-19T12:31:06+00:00  |  Methodology v0.1
...
### 1. DeFi / Trading Infra  —  confidence: High  (score 110.1)

- GitHub repos matching: **49**  (top velocity 70.12 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  Top repos:
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 43.33 stars/day
  - [openarbmev/Openarb-Trade-SDK](https://github.com/openarbmev/Openarb-Trade-SDK) — 10.75 stars/day
  - [neilveriemusm/Trpjan-solana-trading-toolkit](https://github.com/neilveriemusm/Trpjan-solana-trading-toolkit) — 4.17 stars/day

  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 49 trading-infrastructure repos at 70.12 stars/day.
...
### 2. RWA & Tokenization  —  confidence: High  (score 109.1)

- GitHub repos matching: **5**  (top velocity 93.12 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  Top repos:
  - [coolbbcamp/Synthetic-Liquidity-Depth-Scanner](https://github.com/coolbbcamp/Synthetic-Liquidity-Depth-Scanner) — 49.67 stars/day
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 43.33 stars/day
...
### 3. Meme & Speculation  —  confidence: High  (score 99.9)

- GitHub repos matching: **18**  (top velocity 60.66 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **11.6%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [nhovongoc0-max/meme-radar](https://github.com/nhovongoc0-max/meme-radar) — 45.5 stars/day
  - [neilveriemusm/Trpjan-solana-trading-toolkit](https://github.com/neilveriemusm/Trpjan-solana-trading-toolkit) — 4.17 stars/day
  - [dartkomnitibe/solana-meme-tool](https://github.com/dartkomnitibe/solana-meme-tool) — 4.08 stars/day

  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change 11.6%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change 11.6% so traders see which launches have real retention vs. pure rotation.

### 4. Wallets & UX  —  confidence: Medium  (score 68.6)

- GitHub repos matching: **19**  (top velocity 68.6 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 19 new wallet/onboarding repos at 68.6 stars/day.
...
### 5. Dev Tooling & Infra  —  confidence: Medium  (score 57.4)

- GitHub repos matching: **42**  (top velocity 57.44 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 43.33 stars/day
  - [openarbmev/Openarb-Trade-SDK](https://github.com/openarbmev/Openarb-Trade-SDK) — 10.75 stars/day
  - [SohniSwatantra/nosana-mcp](https://github.com/SohniSwatantra/nosana-mcp) — 1.29 stars/day

  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 42 tooling repos at 57.44 stars/day).
...
### 6. AI Agents on Solana  —  confidence: High  (score 23.4)

- GitHub repos matching: **21**  (top velocity 7.41 stars/day)
- Headline mentions (last fortnight): **2**
- Cross-source confirmation: **2/3**
  ...
  Top repos:
  - [PillCrew/claimchain](https://github.com/PillCrew/claimchain) — 1.69 stars/day
  - [SohniSwatantra/nosana-mcp](https://github.com/SohniSwatantra/nosana-mcp) — 1.29 stars/day
  - [PillCrew/PillCrew](https://github.com/PillCrew/PillCrew) — 1.18 stars/day

  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 7.41 stars/day).
...
### 7. Security & Threats  —  confidence: Medium  (score 17.1)

- GitHub repos matching: **4**  (top velocity 1.08 stars/day)
- Headline mentions (last fortnight): **2**
- Cross-source confirmation: **1/3**
  ...
  Top repos:
  - [andreysuperiorgit/aegis](https://github.com/andreysuperiorgit/aegis) — 1.0 stars/day
  ...
  **Build ideas:**
  - Open drainer-signature registry: community-maintained feed of known malicious program IDs + a free API dapps/wallets can query before signing (drainer repos at 1.08 stars/day show industrial-scale scam ops).
...
### 8. DePIN & Physical Infra  —  confidence: Low  (score 1.3)

- GitHub repos matching: **2**  (top velocity 1.31 stars/day)
- Headline mentions (last fortnight): **0**
