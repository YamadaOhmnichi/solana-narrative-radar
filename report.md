...
Generated: 2026-09-22T18:31:44+00:00  |  Methodology v0.1
...
### 1. Meme & Speculation  —  confidence: High  (score 167.0)

- GitHub repos matching: **14**  (top velocity 99.13 stars/day)
- Headline mentions (last fortnight): **2**
- Market 7d avg change: **25.94%**
- Cross-source confirmation: **3/3**
  ...
  Top repos:
  - [Driftmireminisce/SOL-FOR-GIT-CLUB](https://github.com/Driftmireminisce/SOL-FOR-GIT-CLUB) — 48.5 stars/day
  ...
  **Build ideas:**
  - Launchpad honesty score: index every pump.fun-style launch by LP lock, mint authority, holder concentration and dev-wallet behavior; surfaces the few credible launches (avg 7d change 25.94%).
  ...
  - Meme-velocity dashboard: tracks avg 7d change 25.94% so traders see which launches have real retention vs. pure rotation.

### 2. DeFi / Trading Infra  —  confidence: High  (score 93.0)

- GitHub repos matching: **47**  (top velocity 60.98 stars/day)
...
- Cross-source confirmation: **2/3**
  ...
  Top repos:
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 33.57 stars/day
  - [openarbmev/Openarb-Trade-SDK](https://github.com/openarbmev/Openarb-Trade-SDK) — 7.17 stars/day
  - [mangiapanejohn-dev/MOBIUS-Searcher](https://github.com/mangiapanejohn-dev/MOBIUS-Searcher) — 5.0 stars/day

  **Build ideas:**
  - Copy-trading guardrail bot: open-source program + bot that mirrors KOL wallets but with hard loss caps and sandwich-protection, riding the 47 trading-infrastructure repos at 60.98 stars/day.
...
### 3. RWA & Tokenization  —  confidence: Medium  (score 78.5)

- GitHub repos matching: **5**  (top velocity 70.54 stars/day)
...
- Cross-source confirmation: **1/3**
  ...
  Top repos:
  - [coolbbcamp/Synthetic-Liquidity-Depth-Scanner](https://github.com/coolbbcamp/Synthetic-Liquidity-Depth-Scanner) — 36.86 stars/day
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 33.57 stars/day
...
### 4. Wallets & UX  —  confidence: Medium  (score 75.5)

- GitHub repos matching: **20**  (top velocity 75.53 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**

  Top repos:
  - [coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot](https://github.com/coolbbcamp/StonkFun-Multi-Wallet-Volume-Bot) — 33.57 stars/day
  - [Kylerkrausemdzyra64/Crypto-Checker](https://github.com/Kylerkrausemdzyra64/Crypto-Checker) — 21.75 stars/day
  - [openarbmev/Openarb-Trade-SDK](https://github.com/openarbmev/Openarb-Trade-SDK) — 7.17 stars/day

  **Build ideas:**
  - One-tap embedded wallet for Telegram mini-apps on Solana, targeting the wallet-UX friction visible in 20 new wallet/onboarding repos at 75.53 stars/day.
...
### 5. Dev Tooling & Infra  —  confidence: Medium  (score 43.6)

- GitHub repos matching: **42**  (top velocity 43.6 stars/day)
- Headline mentions (last fortnight): **0**
- Cross-source confirmation: **1/3**
  ...
  **Build ideas:**
  - Local-first Solana dev container: one command that ships validator, airdropped test keypair, and explorer UI (rides the 42 tooling repos at 43.6 stars/day).
...
### 6. Security & Threats  —  confidence: Medium  (score 24.0)
...
### 7. AI Agents on Solana  —  confidence: Medium  (score 14.7)

- GitHub repos matching: **18**  (top velocity 6.67 stars/day)
- Headline mentions (last fortnight): **1**
- Cross-source confirmation: **1/3**
  ...
  Top repos:
  - [ayomidefagboyo/kata](https://github.com/ayomidefagboyo/kata) — 2.0 stars/day
  - [PillCrew/claimchain](https://github.com/PillCrew/claimchain) — 1.42 stars/day
  - [SohniSwatantra/nosana-mcp](https://github.com/SohniSwatantra/nosana-mcp) — 1.24 stars/day

  **Build ideas:**
  - Agent-wallet runtime: a Go/Type SDK that gives every AI agent a non-custodial Solana wallet with per-action spend limits and an auditable on-chain action log (rides the 25 new agent repos at 6.67 stars/day).
  - Agent-to-agent escrow program: an Anchor program where two agents lock funds against a task hash and release on verifiable completion — targets the trust gap visible in ayomidefagboyo/kata-style automation repos.
...
### 8. Consumer & Social  —  confidence: Low  (score 9.0)

- GitHub repos matching: **6**  (top velocity 0.99 stars/day)
- Headline mentions (last fortnight): **1**
- Cross-source confirmation: **0/3**
  ...
  - [dizcorvus/opencatz-ai](https://github.com/dizcorvus/opencatz-ai) — 0.19 stars/day
